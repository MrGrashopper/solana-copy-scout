...
CREATE TABLE "new_TraderSnapshot" (
    ...
    "pnlSol" REAL NOT NULL DEFAULT 0,
    CONSTRAINT "TraderSnapshot_runId_fkey" FOREIGN KEY ("runId") REFERENCES "DiscoveryRun" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_TraderSnapshot" ("address", "createdAt", "flags", "id", "lowCapShare", "medianHoldH", "pnlUsd", "profitFactor", "roi", "runId", "score", "sharpe", "trades", "uniqueTokens", "winrate") SELECT "address", "createdAt", "flags", "id", "lowCapShare", "medianHoldH", "pnlUsd", "profitFactor", "roi", "runId", "score", "sharpe", "trades", "uniqueTokens", "winrate" FROM "TraderSnapshot";
